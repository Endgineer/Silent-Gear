...
public class BetaTitaniteShardItem extends TitaniteShardItem {
    public BetaTitaniteShardItem() {
    ...
    public void appendHoverText(ItemStack itemstack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        if(itemstack == null || itemstack.isEmpty() || !itemstack.hasTag()) {
            components.add(new TranslatableComponent("tooltip.silentgear.beta_titanite_shard1").withStyle(ChatFormatting.DARK_GRAY));
        }
    }
}
