...
public class ZetaTitaniteShardItem extends TitaniteShardItem {
    public ZetaTitaniteShardItem() {
    ...
    public void appendHoverText(ItemStack itemstack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        if(itemstack == null || itemstack.isEmpty() || !itemstack.hasTag()) {
            components.add(new TranslatableComponent("tooltip.silentgear.zeta_titanite_shard1").withStyle(ChatFormatting.DARK_GRAY));
        }
    }
}
