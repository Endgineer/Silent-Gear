...
public class GammaTitaniteShardItem extends TitaniteShardItem {
    public GammaTitaniteShardItem() {
    ...
    public void appendHoverText(ItemStack itemstack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        if(itemstack == null || itemstack.isEmpty() || !itemstack.hasTag()) {
            components.add(new TranslatableComponent("tooltip.silentgear.gamma_titanite_shard1").withStyle(ChatFormatting.DARK_GRAY));
        }
    }
}
