...
public class TitaniteOreBlock extends Block {
    ...
    private static void twinkle(Level level, BlockPos pos) {
        ...
        for(Direction direction : Direction.values()) {
            ...
            if(!level.getBlockState(blockpos).isSolidRender(level, blockpos)) {
                ...
                level.addParticle(TitaniteOreBlock.TWINKLE, (double) pos.getX() + d1, (double) pos.getY() + d2, (double) pos.getZ() + d3, 0.0D, 0.0D, 0.0D);
