...
public class TitaniteAnvilBlockEntityRenderer implements BlockEntityRenderer<TitaniteAnvilBlockEntity> {
    ...
    public void render(TitaniteAnvilBlockEntity entity, float partial, PoseStack posestack, MultiBufferSource source, int light, int overlay) {
        ...
        // if(slotstack.is(ModTags.Items.DAEMON_WORKABLE_TOOL)) { angleDegrees = 90; }
        ...
        // ItemStack basestack = entity.getItem(TitaniteAnvilBlockEntity.SLOT_PART_BASE);
        // if(basestack.is(ModTags.Items.DAEMON_TOOL_PART)) { angleDegrees = 45; }

        // posestack.pushPose();
        // switch(entity.getBlockState().getValue(TitaniteAnvilBlock.FACING)) {
        //     case NORTH -> posestack.translate(0.75F, 1.015625, 0.5F);
        //     case EAST -> posestack.translate(0.5F, 1.015625, 0.75F);
        //     case SOUTH -> posestack.translate(0.25F, 1.015625, 0.5F);
        //     case WEST -> posestack.translate(0.5F, 1.015625, 0.25F);
        // }
        // posestack.scale(0.5F, 0.5F, 0.5F);
        // posestack.mulPose(Vector3f.XP.rotationDegrees(90));
        ...
        // renderer.renderStatic(basestack, ItemTransforms.TransformType.GUI, getLightLevel(entity.getLevel(), entity.getBlockPos()), OverlayTexture.NO_OVERLAY, posestack, source, 1);
        // posestack.popPose();


        
        // ItemStack mainstack = entity.getItem(TitaniteAnvilBlockEntity.SLOT_PART_MAIN);
        // if(mainstack.is(ModTags.Items.DAEMON_TOOL_PART)) { angleDegrees = 135; }

        // posestack.pushPose();
        // switch(entity.getBlockState().getValue(TitaniteAnvilBlock.FACING)) {
        //     case NORTH -> posestack.translate(0.25F, 1.015625, 0.5F);
        //     case EAST -> posestack.translate(0.5F, 1.015625, 0.25F);
        //     case SOUTH -> posestack.translate(0.75F, 1.015625, 0.5F);
        //     case WEST -> posestack.translate(0.5F, 1.015625, 0.75F);
        // }
        // posestack.scale(0.5F, 0.5F, 0.5F);
        // posestack.mulPose(Vector3f.XP.rotationDegrees(90));
        ...
        // renderer.renderStatic(mainstack, ItemTransforms.TransformType.GUI, getLightLevel(entity.getLevel(), entity.getBlockPos()), OverlayTexture.NO_OVERLAY, posestack, source, 1);
        // posestack.popPose();
    }
